...
provides=("mpd=${pkgver}")
source=(
  "${pkgname}::git+https://git.code.sf.net/p/sacddecoder/mpd/MPD.git#commit=45f0d8fbce0f52b9aca1f9cce96dcf9c9e1413da"
  mpd.conf
  mpd.sysusers
  mpd.tmpfiles
...
sha512sums=('SKIP'
            ...
            '5ed1903846f56f15607eefcfe1c7cb7bfc12362e12dcc8262f72549b3fa5c9fd1646388e02d2b182ca1613dd16a6b0218c0848718cecad485966551c54dfe718')
b2sums=('SKIP'
        ...
        '49a0dd0c4dba6966fd0e39390fe01bd6cbf9552047efdb43fcbb322ae3f328058b8f79d22d7a053d5ecb30d8b6a73e2c58d12d7c2cd8007d5e7c841eb1abc46a')
